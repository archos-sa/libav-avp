...
CFLAGS=  -I../../android-ndk/platforms/android-21/arch-arm64/usr/include -fPIC -DANDROID -DPIC -I../../android-ndk/sources/cxx-stl/gnu-libstdc++/4.9/include -std=c99 -fomit-frame-pointer -fPIC -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=declaration-after-statement -Werror=vla -Wno-maybe-uninitialized
ASFLAGS=  -I../../android-ndk/platforms/android-21/arch-arm64/usr/include -fPIC -DANDROID -DPIC -I../../android-ndk/sources/cxx-stl/gnu-libstdc++/4.9/include -fPIC -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
