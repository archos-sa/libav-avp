...
OBJCC=../../android-ndk/toolchains/x86-4.9/prebuilt/linux-x86_64/bin/i686-linux-android-gcc
...
CFLAGS=  -I../../android-ndk/platforms/android-14/arch-x86/usr/include -fPIC -DANDROID -DPIC -march=i686 -std=c99 -fomit-frame-pointer -fPIC -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=declaration-after-statement -Werror=vla -Werror=format-security -fdiagnostics-color=auto -Wno-maybe-uninitialized
OBJCFLAGS=  
ASFLAGS=  -I../../android-ndk/platforms/android-14/arch-x86/usr/include -fPIC -DANDROID -DPIC -march=i686 -fPIC -g
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
