...
ARCH=x86
CC=../../android-ndk/toolchains/x86-4.6/prebuilt/linux-x86/bin/i686-linux-android-gcc
AS=../../android-ndk/toolchains/x86-4.6/prebuilt/linux-x86/bin/i686-linux-android-gcc
LD=../../android-ndk/toolchains/x86-4.6/prebuilt/linux-x86/bin/i686-linux-android-gcc
DEPCC=../../android-ndk/toolchains/x86-4.6/prebuilt/linux-x86/bin/i686-linux-android-gcc
YASM=yasm
YASMDEP=yasm
AR=../../android-ndk/toolchains/x86-4.6/prebuilt/linux-x86/bin/i686-linux-android-ar
RANLIB=../../android-ndk/toolchains/x86-4.6/prebuilt/linux-x86/bin/i686-linux-android-ranlib
LN_S=ln -sf
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC
CFLAGS= -I../../android-ndk/platforms/android-9/arch-x86/usr/include -fPIC -DANDROID -DPIC -I../../android-ndk/sources/cxx-stl/gnu-libstdc++/4.6/include -I/include  -std=c99 -fomit-frame-pointer -fPIC -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=declaration-after-statement
ASFLAGS= -I../../android-ndk/platforms/android-9/arch-x86/usr/include -fPIC -DANDROID -DPIC -I../../android-ndk/sources/cxx-stl/gnu-libstdc++/4.6/include -I/include  -fPIC -g
AS_O=-o $@
CC_O=-o $@
DLLTOOL=
LDFLAGS= -Wl,-T,../../android-ndk/toolchains/x86-4.6/prebuilt/linux-x86/i686-linux-android/lib/ldscripts/elf_i386.x -Wl,-rpath-link=../../android-ndk/platforms/android-9/arch-x86/usr/lib -L../../android-ndk/platforms/android-9/arch-x86/usr/lib -nostdlib ../../android-ndk/toolchains/x86-4.6/prebuilt/linux-x86/lib/gcc/i686-linux-android/4.6.x-google/crtbegin.o ../../android-ndk/toolchains/x86-4.6/prebuilt/linux-x86/lib/gcc/i686-linux-android/4.6.x-google/crtend.o -lc -lm -ldl -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
