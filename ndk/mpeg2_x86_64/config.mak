...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=x86_64 --enable-cross-compile --cc=../../android-ndk/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-gcc --cross-prefix=../../android-ndk/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android- --nm=../../android-ndk/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-nm --ld=../../android-ndk/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-ld --extra-cflags=' -I../../android-ndk/platforms/android-21/arch-x86_64/usr/include -fPIC -DANDROID -DPIC' --extra-ldflags='-L../../android-ndk/platforms/android-21/arch-x86_64/usr/lib64 ../../android-ndk/toolchains/x86_64-4.9/prebuilt/linux-x86_64/lib/gcc/x86_64-linux-android/4.9/crtbegin.o ../../android-ndk/toolchains/x86_64-4.9/prebuilt/linux-x86_64/lib/gcc/x86_64-linux-android/4.9/crtend.o -nostdlib -lc -lm -ldl' --prefix=/system --libdir=/system/lib --enable-asm --enable-yasm --enable-pic --enable-shared --disable-bzlib --disable-libfaac --disable-muxers --disable-demuxers --disable-parsers --disable-bsfs --disable-protocols --disable-avdevice --disable-devices --disable-filters --disable-encoders --disable-decoders --enable-decoder=cook --enable-decoder=flac --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=mp2 --enable-decoder=mp3 --enable-decoder=wavpack --enable-decoder=tta --enable-decoder=vorbis --enable-decoder=amrnb --enable-decoder=amrwb --enable-decoder=msmpeg4v1 --enable-decoder=msmpeg4v2 --enable-decoder=msmpeg4v3 --enable-decoder=h263 --enable-decoder=h264 --enable-decoder=hevc --enable-decoder=mpeg4 --enable-decoder=mpegvideo --enable-decoder=mpeg1video --enable-decoder=flv --enable-decoder=rv10 --enable-decoder=rv20 --enable-decoder=rv30 --enable-decoder=rv40 --enable-decoder=mjpeg --enable-decoder=vp6f --enable-decoder=vp8 --enable-decoder=wmv1 --enable-decoder=wmv2 --enable-decoder=wmv3 --enable-decoder=vc1 --enable-decoder=mpeg2video --enable-decoder=theora --enable-demuxer=avi --enable-demuxer=matroska --enable-demuxer=rtsp --enable-demuxer=sdp --enable-demuxer=aac --enable-demuxer=aac_latm --enable-demuxer=mp3 --enable-demuxer=h261 --enable-demuxer=h263 --enable-demuxer=h264 --enable-demuxer=hevc --enable-demuxer=mpegts --enable-demuxer=mpegtsraw --enable-demuxer=mpegps --enable-demuxer=mpegvideo --enable-demuxer=wtv --enable-demuxer=ac3 --enable-demuxer=ogg --enable-protocol=file --enable-protocol=http --enable-protocol=rtp --enable-protocol=tcp --enable-protocol=udp --enable-parser=aac --enable-parser=aac_latm --enable-parser=h261 --enable-parser=h263 --enable-parser=h264 --enable-parser=hevc --enable-parser=mpeg4video --enable-parser=mpegaudio --enable-parser=mpegvideo --enable-parser=flac --enable-parser=dca --disable-static --disable-symver --enable-memalign-hack --enable-decoder=mpeg2video --enable-decoder=mp2
prefix=/system
...
ARCH=x86
INTRINSICS=none
CC=../../android-ndk/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-gcc
CXX=../../android-ndk/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-g++
AS=../../android-ndk/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-gcc
LD=../../android-ndk/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-ld
DEPCC=../../android-ndk/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=../../android-ndk/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=../../android-ndk/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-ar
ARFLAGS=rcD
AR_O=$@
RANLIB=../../android-ndk/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-ranlib -D
STRIP=../../android-ndk/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -I../../android-ndk/platforms/android-21/arch-x86_64/usr/include -fPIC -DANDROID -DPIC -std=c99 -fomit-frame-pointer -fPIC -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -I../../android-ndk/platforms/android-21/arch-x86_64/usr/include -fPIC -DANDROID -DPIC -fPIC -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=../../android-ndk/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-windres
DEPWINDRES=../../android-ndk/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-gcc
DOXYGEN=doxygen
LDFLAGS= -L../../android-ndk/platforms/android-21/arch-x86_64/usr/lib64 ../../android-ndk/toolchains/x86_64-4.9/prebuilt/linux-x86_64/lib/gcc/x86_64-linux-android/4.9/crtbegin.o ../../android-ndk/toolchains/x86_64-4.9/prebuilt/linux-x86_64/lib/gcc/x86_64-linux-android/4.9/crtend.o -nostdlib -lc -lm -ldl  
LDEXEFLAGS=
