...
CFLAGS=  -I../../android-ndk/platforms/android-21/arch-x86_64/usr/include -fPIC -DANDROID -DPIC -march=atom -std=c99 -fomit-frame-pointer -fPIC -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=declaration-after-statement -Werror=vla -Wno-maybe-uninitialized
ASFLAGS=  -I../../android-ndk/platforms/android-21/arch-x86_64/usr/include -fPIC -DANDROID -DPIC -march=atom -fPIC -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
